...
Sc.add(
	Plane(
		material=white_diffuse, center=vec3(555.0 / 2.0, 555.0 / 2.0, -555.0), 
  		width=555.0, height=555.0, 
    	u_axis=vec3(0.0, 1.0, 0), v_axis=vec3(1.0, 0.0, 0.0)
	)
)
Sc.add(
	Plane(
		material=green_diffuse, center=vec3(0.0, 555.0 / 2.0, -555.0 / 2.0), 
  		width=555.0, height=555.0,
...
Sc.add(
	Plane(
		material=white_diffuse, center=vec3(555.0 / 2.0, 0.0, -555.0 / 2.0), 
  		width=555.0, height=555.0,
    	u_axis=vec3(1.0, 0.0, 0.0), v_axis=vec3(0.0, 0.0, -1.0)
	)
)
...
Sc.add(
	Sphere(
		material=blue_glass, center=vec3(370.5, 165. / 2., -65. - 185. / 2.), radius=165. / 2., 
