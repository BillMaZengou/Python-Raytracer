...
from .utils.vector3 import extract, rgb
import numpy as np
...
class Ray:    
    ...
    def extract(self,hit_check):
        return Ray(
            self.origin.extract(hit_check), self.dir.extract(hit_check), 
            self.depth, self.n.extract(hit_check), 
