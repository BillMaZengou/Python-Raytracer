...
bluish_metal = Glossy(diff_color=rgb(0.0, 0.0, 0.1), n=vec3(1.3 + 1.91j, 1.3 + 1.91j, 1.4 + 2.91j), roughness=0.2, spec_coeff=0.5, diff_coeff=0.3)
floor = Glossy(
    diff_color=image("checkered_floor.png", repeat = 80.),   
...
Sc.add(Plane(material=floor, center=vec3(0, -0.5, -3.0), width=120.0, height=120.0, u_axis=vec3(1, 0, 0), v_axis=vec3(0, 0, -1), max_ray_depth=3))
